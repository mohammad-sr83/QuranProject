                ...
                <div className="flex justify-between items-center p-6 ">
                    ...
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-4">
                                <Link href="#" className=" hover:underline sm:text-lg">القرآن وعلومه</Link>
                            </li>
                            <li className="mb-4">
                                <Link href="#" className="hover:underline sm:text-lg">الحديث وعلومه</Link>
                            </li>
                            <li className="mb-4">
                                <Link href="#" className="hover:underline sm:text-lg">العقائد والكلام</Link>
                            </li>
                            <li className="mb-4">
                                <Link href="#" className="hover:underline">سيرة النبي (ص) وأهل البيت (ع)</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-3">
                                <Link href="#" className="hover:underline sm:text-lg">العقائد الاسلامية</Link>
                            </li>
                            <li className="mb-3">
                                <Link href="#" className="hover:underline sm:text-lg">الصوتيات والمرئيات</Link>
                            </li>
                            <li className="mb-3">
                                <Link href="#" className="hover:underline sm:text-lg">المکتبة الإسلامية</Link>
                            </li>
                            <li className="mb-3">
                                <Link href="#" className="hover:underline sm:text-lg">المؤمل</Link>
                            </li>
                        </ul>
                    </div>
                </div>
